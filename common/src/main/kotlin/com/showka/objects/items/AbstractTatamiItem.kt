...
abstract class AbstractTatamiItem(
    ...
    companion object {
        ...
        /**
         * Factory method for color variations.
         * Creates instances without subclassing.
         */
        fun create(
            properties: Properties,
            layout: TatamiLayout,
            partBlockProvider: () -> AbstractTatamiPartBlock,
            partProperty: IntegerProperty
        ): AbstractTatamiItem = object : AbstractTatamiItem(properties, layout, partBlockProvider, partProperty) {}
    }
